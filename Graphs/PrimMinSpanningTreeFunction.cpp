...
//We start from the first node and pick the minimum edge out of all its connections then
//we pick the minimum edge out of all connections with the nodes in our edge 
//Now we have three connections so we repeat the second step until we reach the end of the tree 
